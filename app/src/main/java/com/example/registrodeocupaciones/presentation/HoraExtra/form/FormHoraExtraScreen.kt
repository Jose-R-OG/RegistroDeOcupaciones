...
fun EditHoraExtraScreen(
    ...
    LaunchedEffect(horaExtraId) {
        viewModel.onEvent(FormHoraExtraUiEvent.Load(horaExtraId))
    }
    ...
    if (showDateDesdePicker) {
        ...
        DatePickerDialog(
            ...
            confirmButton = {
                TextButton(onClick = {
                    viewModel.onEvent(
                        FormHoraExtraUiEvent.FechaDesdeChanged(datePickerState.selectedDateMillis)
                    )
    ...
    if (showDateHastaPicker) {
        ...
        DatePickerDialog(
            ...
            confirmButton = {
                TextButton(onClick = {
                    viewModel.onEvent(
                        FormHoraExtraUiEvent.FechaHastaChanged(datePickerState.selectedDateMillis)
                    )
